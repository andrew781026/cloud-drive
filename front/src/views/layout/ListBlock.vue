<template>
  <div class="list-root" :class="[collapse && 'is-collapse']">
    <el-table
        height="100%"
        class="file-table"
...
import {collapse} from '@/compositions/usePinCollapse';

export default {
  name: "ListBlock",
  setup() {
    return {collapse, tableData, getTableData};
  },
  mounted() {
